...
const themaes=[
    {
        ...
        contentsText: `
        <p>당신의 세계를 누비는 탐험가!</p>
        <p>마지막 목표는 이집트의 피라미드!</p>
        <p>엄청난 보물의 근원지를 파악했다는 정보를 입수했다.</p>
        <p>화려한 여행의 마무리를 짓기위해서 가족과 연인을 동반해서 탐험에 나섰다!</p>
        <p>불가사의 한 피라미드를 탐험 중 당신과 일행은 피라미드에 갇치게 된다.</p>
        <p>방안의 모든 단서를 이용하여 피라미드를 탈출해야 한다.</p>
        <p>주어진 시간은 단 60분 시간 내에 피라미드를 탈출하라!</p>
        `,
        level: "⭐⭐⭐",
        title: "피라미드",
        type: "어드벤처",
