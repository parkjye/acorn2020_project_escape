...
<div class="container">
	...
	<ul class="thema-list col-md-4">
		<li class="thema">
			<div class="thema-info">
				<div class="thema-image">
					<img src="http://incheon.cubeescape.co.kr/theme/basic_room2/img/rain/room14.jpg" alt="테마: The Cube" />
				</div>
	...
	<ul class="thema-list col-md-4">
		...
		<li class="thema">
			<div class="thema-info">
				<div class="thema-image">
					<img src="http://cheonho.cubeescape.co.kr/theme/basic_room2/img/rain/room23.jpg" alt="테마: 마녀의 꿈" />
				</div>
				<div class="text-center">난이도: 4/5</div>
