	...
	<table class="table">
		<tbody>
			<tr>
			  <td>주소</td>
			  <td>:</td>
			  <td>대구 광역시 중구 동성로2길 81, 3층(동성로2가, 금산빌딩)</td>
			</tr>
			<tr>
			  <td>연락처</td>
			  <td>:</td>
			...
			<tr>
			  <td>영업시간</td>
			  <td>:</td>
			  <td>일~목:10:00부터 ~ 23:45까지<br/>  금/토/공휴일 전날 10:00부터 ~ 익일 02:20까지</td>
			</tr>
		 </tbody>
	</table>
</div>
